...
public abstract class DrawPlayableAreaHelperNewP1BenchmarkBase
{
    ...
    private static double? CalculateBoundaryXGridUnitNoLinq(LaneStartBase lane, TGrid tGrid, BoundaryEdge edge)
    {
        ...
        var childCount = 0;
        OngekiFumenEditor.Avalonia.Base.OngekiObjects.ConnectableObject.ConnectableChildObjectBase? firstChild = null;
        OngekiFumenEditor.Avalonia.Base.OngekiObjects.ConnectableObject.ConnectableChildObjectBase? firstExactChild = null;
        OngekiFumenEditor.Avalonia.Base.OngekiObjects.ConnectableObject.ConnectableChildObjectBase? lastExactChild = null;
