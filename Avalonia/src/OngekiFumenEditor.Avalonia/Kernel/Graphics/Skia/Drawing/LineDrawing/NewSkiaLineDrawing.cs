...
{
    /// <summary>
    /// Skia line drawing used by the draw command replay.
    /// Ported from the WPF final implementation (OngekiFumenEditor/Kernel/Graphics/Skia/Drawing/LineDrawing/NewSkiaLineDrawing.cs),
    /// which replaced the previous per-segment implementation with SKPath pooling, cached dash effects,
    /// run merging and a triangle mesh fallback for heavy gradients.
    /// </summary>
