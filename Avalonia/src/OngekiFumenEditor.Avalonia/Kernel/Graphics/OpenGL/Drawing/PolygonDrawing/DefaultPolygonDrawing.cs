...
using OngekiFumenEditor.Avalonia.Kernel.Graphics.OpenGL.Drawing.LineDrawing;
using OpenTK.Graphics.OpenGL;
using System;
using Injectio.Attributes;

namespace OngekiFumenEditor.Avalonia.Kernel.Graphics.OpenGL.Drawing.PolygonDrawing
{
