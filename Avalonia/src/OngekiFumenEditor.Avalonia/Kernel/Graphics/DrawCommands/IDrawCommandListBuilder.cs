...
namespace OngekiFumenEditor.Avalonia.Kernel.Graphics.DrawCommands
{
    ...
    public interface IDrawCommandListBuilder : IDisposable
    {
        ...
        /// </summary>
        void SetCleanColor(System.Numerics.Vector4? color);
        ...
        /// </summary>
        void PushModelMatrix(Matrix4 matrix);

        /// <summary>
        /// Pushes a view matrix scope and records a state-change command.
        /// </summary>
        void PushViewMatrix(Matrix4 matrix);
        ...
        /// </summary>
        void DrawCircle(System.Numerics.Vector2 point, System.Numerics.Vector4 color, bool isSolid, float radius, float hollowLineWidth = 0);
        ...
        /// </summary>
        void DrawString(string text, System.Numerics.Vector2 pos, System.Numerics.Vector2 scale, int fontSize, float rotate, System.Numerics.Vector4 color, System.Numerics.Vector2 origin, IStringDrawing.StringStyle style, IStringDrawing.IFontHandle handle);
        ...
        /// </summary>
        void DrawBeam(IImage texture, int width, float x, float progress, System.Numerics.Vector4 color, float rotate, float judgeOffset);
