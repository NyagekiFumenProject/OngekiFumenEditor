...
namespace OngekiFumenEditor.Avalonia.Kernel.Graphics.DrawCommands
{
    ...
    public sealed class DrawCommandListBuilder : IDrawCommandListBuilder
    {
        ...
        private IPooledList<Matrix4> modelMatrixStack;
        private IPooledList<Matrix4> viewMatrixStack;
        private IPooledList<Matrix4> projectionMatrixStack;
        ...
        private System.Numerics.Vector4? cleanColor;
        ...
        public DrawCommandListBuilder(IStringMeasure stringMeasurer = default)
        {
            ...
            modelMatrixStack = ObjectPool.GetPooledList<Matrix4>();
            viewMatrixStack = ObjectPool.GetPooledList<Matrix4>();
            projectionMatrixStack = ObjectPool.GetPooledList<Matrix4>();
        ...
        public void SetCleanColor(System.Numerics.Vector4? color)
        {
            ThrowIfDisposed();
            cleanColor = color;
        }
        ...
        public void SetCurrentModelMatrix(Matrix4 matrix)
        {
            ThrowIfDisposed();
            modelMatrix = matrix;
        ...
        public void SetCurrentViewMatrix(Matrix4 matrix)
        {
            ThrowIfDisposed();
            viewMatrix = matrix;
        ...
        public void SetCurrentProjectionMatrix(Matrix4 matrix)
        {
            ThrowIfDisposed();
        ...
        public void PushModelMatrix(Matrix4 matrix)
        {
            ThrowIfDisposed();
        ...
        public void PushViewMatrix(Matrix4 matrix)
        {
            ThrowIfDisposed();
        ...
        public void DrawCircle(System.Numerics.Vector2 point, System.Numerics.Vector4 color, bool isSolid, float radius, float hollowLineWidth = 0)
        {
            ThrowIfDisposed();
        ...
        public void DrawString(string text, System.Numerics.Vector2 pos, System.Numerics.Vector2 scale, int fontSize, float rotate, System.Numerics.Vector4 color, System.Numerics.Vector2 origin, IStringDrawing.StringStyle style, IStringDrawing.IFontHandle handle)
        {
            ThrowIfDisposed();
        ...
        public System.Numerics.Vector2 MeasureString(string text, System.Numerics.Vector2 scale, int fontSize, IStringDrawing.StringStyle style, IStringDrawing.IFontHandle handle)
        {
            ThrowIfDisposed();
        ...
        public void DrawBeam(IImage texture, int width, float x, float progress, System.Numerics.Vector4 color, float rotate, float judgeOffset)
        {
            ThrowIfDisposed();
            ArgumentNullException.ThrowIfNull(texture, nameof(texture));
        ...
        public void Dispose()
        {
            ...
            shortLastDrawCommandLocationMap?.Dispose();
        ...
        {
            cleanColor = new System.Numerics.Vector4(0, 0, 0, 1);
            viewWidth = 0;
            viewHeight = 0;
            renderScaleX = 1;
            renderScaleY = 1;
        ...
        private static Matrix4 PopMatrix(IPooledList<Matrix4> stack, string operationName)
        {
            if (stack.Count == 0)
