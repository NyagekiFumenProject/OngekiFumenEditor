...
namespace OngekiFumenEditor.Avalonia.Kernel.Graphics.DrawCommands
{
    ...
    public readonly record struct DrawCommandListFrameState
    {
        ...
        /// </summary>
        public DrawCommandListFrameState(System.Numerics.Vector4? cleanColor, float viewWidth, float viewHeight, float renderScaleX, float renderScaleY, Matrix4 modelMatrix, Matrix4 viewMatrix, Matrix4 projectionMatrix)
        {
        ...
        /// </summary>
        public System.Numerics.Vector4? CleanColor { get; init; }
        ...
        /// </summary>
        public Matrix4 ViewMatrix { get; init; }

        /// <summary>
        /// Gets the current projection matrix captured when the list was built.
        /// </summary>
        public Matrix4 ProjectionMatrix { get; init; }
    }
}
