...
namespace OngekiFumenEditor.Avalonia.Base.OngekiObjects.ConnectableObject
{
    public abstract class ConnectableChildObjectBase : ConnectableObjectBase
    {
        ...
        {
            get => curvePrecision;
            set => SetProperty(ref curvePrecision, value <= 0 ? 0.01f : value);
        }
        ...
        public ConnectableObjectBase PrevObject
        {
            ...
            set
            {
                ...
                SetProperty(ref prevObject, value);
                if (prevObject is not null)
        ...
        public override int RecordId { get => ReferenceStartObject?.RecordId ?? recordId; set => SetProperty(ref recordId, value); }
