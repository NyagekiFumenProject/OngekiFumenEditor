...
public static class TGridCalculator
{
    ...
    public static TGrid ConvertAudioTimeToTGrid(TimeSpan audioTime, FumenVisualEditorViewModel editor) =>
        ConvertAudioTimeToTGrid(audioTime, editor.EditorContext.Fumen.BpmList);
    ...
    public static TimeSpan ConvertTGridToAudioTime(TGrid tGrid, FumenVisualEditorViewModel editor) =>
        ConvertTGridToAudioTime(tGrid, editor.EditorContext.Fumen.BpmList);
    ...
    public static TGrid ConvertYToTGrid_DesignMode(double pickY, FumenVisualEditorViewModel editor) =>
        ConvertYToTGrid_DesignMode(pickY, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.Setting.VerticalDisplayScale);
    ...
    public static TimeSpan ConvertYToAudioTime_DesignMode(double pickY, FumenVisualEditorViewModel editor) =>
        ConvertYToAudioTime_DesignMode(pickY, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.Setting.VerticalDisplayScale);
    ...
    public static double ConvertTGridToY_DesignMode(TGrid tGrid, FumenVisualEditorViewModel editor) =>
        ConvertTGridToY_DesignMode(tGrid, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.Setting.VerticalDisplayScale);
    ...
    public static double ConvertTGridUnitToY_DesignMode(double tGridUnit, FumenVisualEditorViewModel editor) =>
        ConvertTGridUnitToY_DesignMode(tGridUnit, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.Setting.VerticalDisplayScale);
    ...
    public static IEnumerable<TGrid> ConvertYToTGrid_PreviewMode(double pickY, FumenVisualEditorViewModel editor) =>
        ConvertYToTGrid_PreviewMode(pickY, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.Setting.VerticalDisplayScale);
    ...
    public static double ConvertTGridToY_PreviewMode(TGrid tGrid, FumenVisualEditorViewModel editor) =>
        ConvertTGridToY_PreviewMode(tGrid, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.Setting.VerticalDisplayScale);
    ...
    public static double ConvertTGridUnitToY_PreviewMode(double tGridUnit, FumenVisualEditorViewModel editor) =>
        ConvertTGridUnitToY_PreviewMode(tGridUnit, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.Setting.VerticalDisplayScale);
    ...
    public static IEnumerable<(TGrid tGrid, double y, int beatIndex, MeterChange meter, BPMChange bpm)> GetVisbleTimelines_DesignMode(FumenVisualEditorViewModel editor) =>
        GetVisbleTimelines_DesignMode(editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.EditorContext.Fumen.MeterChanges,
    ...
    public static (TimeSpan audioTime, TGrid startTGrid, MeterChange meter, BPMChange bpm) GetCurrentTimeSignature(TGrid tGrid, FumenVisualEditorViewModel editor) =>
        GetCurrentTimeSignature(tGrid, editor.EditorContext.Fumen.BpmList, editor.EditorContext.Fumen.MeterChanges);
    ...
    public static List<(TimeSpan audioTime, BPMChange bpm)> GetAllBpmUniformPositionList(FumenVisualEditorViewModel editor) =>
        GetAllBpmUniformPositionList(editor.EditorContext.Fumen.BpmList);
    ...
    public static (TGrid tGrid, double y, int beatIndex) TryPickMagneticBeatTime(float y, float range, FumenVisualEditorViewModel editor) =>
        TryPickMagneticBeatTime_DesignMode(y, range, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.EditorContext.Fumen.MeterChanges,
    ...
    public static (TGrid tGrid, double y, int beatIndex) TryPickClosestBeatTime(float y, FumenVisualEditorViewModel editor) =>
        TryPickClosestBeatTime_DesignMode(y, editor.EditorContext.Fumen.SoflansMap.DefaultSoflanList, editor.EditorContext.Fumen.BpmList, editor.EditorContext.Fumen.MeterChanges,
            editor.Setting.BeatSplit, editor.Setting.VerticalDisplayScale);
