...
using OngekiFumenEditor.Avalonia.Modules.FumenVisualEditor.ViewModels.Interactives;
    ...
    public partial class FumenVisualEditorViewModel : DocumentViewModelBase
    {
        ...
        public bool IsLocked
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(EditorObjectVisibility));
                OnPropertyChanged(nameof(EditorLockedVisibility));
        ...
        private bool IsUserRequestHideEditorObject
        {
            ...
            set
            {
                SetProperty(ref isUserRequestHideEditorObject, value);
                OnPropertyChanged(nameof(EditorObjectVisibility));
                OnPropertyChanged(nameof(IsDesignMode));
                OnPropertyChanged(nameof(IsPreviewMode));
            }
        ...
        public bool EditorLockedVisibility =>
            IsLocked
                ? false : true;
        ...
        public void MenuItemAction_MirrorSelectionXGridZero(ActionExecutionContext ctx)
        {
            ...
            UndoRedoManager.ExecuteAction(new LambdaUndoAction(Lang.MirrorSelectionXGridZero, func, func));
        }
        ...
        public void MenuItemAction_MirrorSelectionXGrid(ActionExecutionContext ctx)
        {
            ...
            UndoRedoManager.ExecuteAction(new LambdaUndoAction(Lang.MirrorSelectionXGrid, func, func));
        }
        ...
        public void MenuItemAction_MirrorLaneColors(ActionExecutionContext ctx)
        {
            ...
            UndoRedoManager.ExecuteAction(new LambdaUndoAction(Lang.MirrorSelectionLaneColors, executeOrRedo, undo));
        }
        ...
        public void MenuItemAction_RememberSelectedObjectAudioTime(ActionExecutionContext e)
        {
            ...
            foreach (var obj in SelectObjects)
            {
                if (obj is ITimelineObject timelineObject)
                    ...
                    ToastNotify(Lang.CantRememberObjectByNotSupport.Format(obj));
            }
        ...
        public void MenuItemAction_RecoverySelectedObjectToAudioTime(ActionExecutionContext e)
        {
            ...
            UndoRedoManager.ExecuteAction(LambdaUndoAction.Create(Lang.B.RecoveryObjectToAudioTime.ToLocalizedString(),
                () =>
                {
                    ...
                    ToastNotify(Lang.RecoveryObjectsSuccess.Format(recoverTargets.Count));
                }, () =>
                {
                    foreach ((var timelineObject, var undoTGrid) in undoTargets)
                        timelineObject.TGrid = undoTGrid.CopyNew();
                    ToastNotify(Lang.UndoRecoveryObjectsSuccess.Format(recoverTargets.Count));
                }
            ));
        }
        ...
        public void KeyboardAction_ChangeDockableLaneType(ActionExecutionContext e)
        {
            ...
            {
                ToastNotify(Lang.SelectOneDockableLaneOnly);
                return;
            }
        ...
        public void KeyboardAction_FastPlaceDockableObject(LaneType targetType)
        {
            ...
            {
                ToastNotify(Lang.MustSelectOneTapOrHold);
                return;
            }
        ...
        public void KeyboardAction_FastPlaceDockableObject(LaneType targetType, ILaneDockable dockable)
        {
            ...
            if (pickLane is null)
            {
                ToastNotify(Lang.CantPlaceObjectsByNoSuiteLanes.Format(targetType));
                return;
            }

            UndoRedoManager.ExecuteAction(LambdaUndoAction.Create(Lang.B.FastPlaceObjectToLane.ToLocalizedString().Format(dockable.GetType().Name, targetType), () =>
            {
        ...
        public void DeleteSelection(IEnumerable<OngekiObjectBase> selection = null)
        {
            ...
            UndoRedoManager.ExecuteAction(LambdaUndoAction.Create(Lang.B.DeleteObjects.ToLocalizedString(), () =>
            {
        ...
        public void KeyboardAction_FastSetObjectIsCritical(ActionExecutionContext e)
        {
            ...
            if (map.Count == 0)
            {
                ToastNotify(Lang.NoObjectCouldBeSetIsCritical);
                return;
            }

            var setVal = !isAllCritical;

            UndoRedoManager.ExecuteAction(LambdaUndoAction.Create(Lang.B.BatchSetIsCritical.ToLocalizedString(), () =>
            {
        ...
        public void KeyboardAction_FastSwitchFlickDirection(ActionExecutionContext _)
        {
            ...
            {
                ToastNotify(Lang.NoFlickCouldBeSwitched);
                return;
            }

            UndoRedoManager.ExecuteAction(LambdaUndoAction.Create(Lang.B.BatchSwitchFlickDirection.ToLocalizedString(), ChangeFlicks, ChangeFlicks));
        ...
        public bool CheckAndNotifyIfPlaceBeyondDuration(Point placePoint)
        {
            if (placePoint.Y > TotalDurationHeight || placePoint.Y < 0)
            {
                ...
                {
                    ToastNotify(Lang.DisableAddObjectBeyondAudioDuration);
                    return false;
                }
            }
        ...
        private void ProcessAsAddCurve(ConnectableChildObjectBase child, Point position)
        {
            ...
            UndoRedoManager.ExecuteAction(LambdaUndoAction.Create(Lang.B.AddCurveControlPoint.ToLocalizedString(), () =>
            {
        ...
        private void ProcessAsAddNextObjects(Point position, ConnectableObjectBase[] selects)
        {
            ...
            var combinedAction = UndoRedoManager.EndCombineAction(Lang.FastAddObjectsToLanes);
                ...
                if (arg.ChangedButton == MouseButton.Left)
                {
                    ...
                    else
                    {
                        if (isSelectRangeDragging)
                        {
                            ...
                            var compositeAction = UndoRedoManager.EndCombineAction(Lang.B.DragObjects.ToLocalizedString());
