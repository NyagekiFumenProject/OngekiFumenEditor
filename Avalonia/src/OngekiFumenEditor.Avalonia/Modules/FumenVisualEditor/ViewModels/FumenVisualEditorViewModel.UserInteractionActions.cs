...
namespace OngekiFumenEditor.Avalonia.Modules.FumenVisualEditor.ViewModels
{
    public partial class FumenVisualEditorViewModel : DocumentViewModelBase
    {
        ...
        public void KeyboardAction_FastPlaceDockableObject(LaneType targetType, ILaneDockable dockable)
        {
            ...
            UndoRedoManager.ExecuteAction(LambdaUndoAction.Create(Lang.B.FastPlaceObjectToLane.ToFormatLocalizedString(dockable.GetType().Name, targetType), () =>
            {
        ...
        private void ProcessAsAddNextObjects(Point position, ConnectableObjectBase[] selects)
        {
            ...
            UndoRedoManager.ExecuteAction(LambdaUndoAction.Create(string.Empty.ToLocalizedStringByRawText(), () =>
            {
