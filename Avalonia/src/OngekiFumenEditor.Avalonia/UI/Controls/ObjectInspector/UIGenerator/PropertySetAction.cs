...
{
    public PropertySetAction(string propName, Action<object> setterAction, object oldValue, object newValue)
        : base(propName, setterAction, oldValue, newValue)
    {
    }

    public PropertySetAction(string propName, IObjectPropertyAccessProxy propertyWrapperCore, object oldValue, object newValue)
        : base(propName, propertyWrapperCore, oldValue, newValue)
    {
    }
}
