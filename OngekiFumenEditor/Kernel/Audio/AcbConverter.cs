...
namespace OngekiFumenEditor.Kernel.Audio
{
    public static class AcbConverter
    {
        ...
        private static void ProcessAllBinaries(uint acbFormatVersion, string extractFilePath, Afs2Archive archive, Stream dataStream)
        {
            ...
            foreach (var entry in archive.Files)
            {
                ...
                if (HcaReader.IsHcaStream(fileData))
                {
                    ...
                    try
                    {
                        ...
                        DecodeHca(fileData, fs, DecodeParams.Default);
        ...
        public static Task<string> ConvertAcbFileToWavFile(string filePath)
        {
            return Task.Run(() =>
            {
                mutex.WaitOne();
                ...
                try
                {
                    ...
                    ProcessAllBinaries(acb.FormatVersion, tempAwbFilePath, awb, awbStream);
