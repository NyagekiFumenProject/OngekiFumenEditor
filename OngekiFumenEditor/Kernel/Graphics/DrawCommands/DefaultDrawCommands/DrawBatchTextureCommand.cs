...
namespace OngekiFumenEditor.Kernel.Graphics.DrawCommands.DefaultDrawCommands
{
    ...
    /// </summary>
    public sealed record DrawBatchTextureCommand : DrawCommand
    {
        private IPooledList<TextureInstance> instances;

        /// <summary>
        /// Initializes a batched texture drawing command.
        /// </summary>
        public DrawBatchTextureCommand(IImage texture, IPooledList<TextureInstance> instances)
        {
