...
namespace OngekiFumenEditor.Modules.FumenVisualEditor.Graphics.Drawing.DefaultDrawingImpl
{
    public class CommonDrawingBase : IDrawing
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Matrix4 GetOverrideViewProjectMatrixOrDefault(IFumenEditorDrawingContext ctx)
        {
