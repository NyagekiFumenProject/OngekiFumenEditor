...
namespace OngekiFumenEditor.Modules.OptionGeneratorTools.ViewModels
{
    ...
    public class MusicXmlWindowViewModel : WindowBase, IMusicXmlGenerator
    {
        ...
        public async void Save()
        {
            ...
            var result = await Generate(saveFilePath, MusicXmlOption);
            if (!result)
            {
                MessageBox.Show(Resources.GenerateMusicXmlFile + Resources.Fail);
                return;
            }
            ...
            MessageBox.Show(Resources.GenerateMusicXmlFile + Resources.Success);
        }
