...
namespace OngekiFumenEditor.Parser.DefaultImpl.Nyageki.CommandImpl.Objects
{
    ...
    public class LaneCommandParser : INyagekiCommandParser
    {
        ...
        public void ParseAndApply(OngekiFumen fumen, string[] seg)
        {
            ...
            void buildColorfulLane(IColorfulLane obj, IDictionary<string, string> map)
            {
            ...
            LaneStartBase startObject = startData["Type"] switch
            {
            ...
            startObject.IsTransparent = startData.TryGetValue(nameof(startObject.IsTransparent), out var t) ? bool.Parse(t) : false;
