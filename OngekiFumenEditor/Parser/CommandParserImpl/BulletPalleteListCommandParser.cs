...
using static OngekiFumenEditor.Base.OngekiObjects.BulletPalleteList;

namespace OngekiFumenEditor.Parser.CommandParserImpl
{
    [Export(typeof(ICommandParser))]
    public class BulletPalleteListCommandParser : ICommandParser
    {
