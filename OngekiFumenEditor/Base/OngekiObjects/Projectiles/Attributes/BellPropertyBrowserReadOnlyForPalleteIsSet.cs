...
{
    public class BellPropertyBrowserReadOnlyForPalleteIsSet : ObjectPropertyBrowserReadOnlyForCondition<IBulletPalleteReferencable>
    {
        public BellPropertyBrowserReadOnlyForPalleteIsSet() :
